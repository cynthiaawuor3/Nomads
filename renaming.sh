...
rename_file="/home/cynthia/NOMADS/2024-08-02_AnGam_CAO/no_sample/20240802_1622_MN30463_FAZ32935_b86dbc88/fastq_pass/newname.txt"

# Loop over all normalized VCF files in the directory
for vcf_file in ${vcf_dir}/barcode*.normalized.vcf; do
  # Extract the base name without the extension
  base_name=$(basename "$vcf_file" .normalized.vcf)
  ...
  bcftools annotate --rename-chrs "$rename_file" -o "$output_file" "$vcf_file"
